...
namespace Repository.ir.shaparak.sep1 {
    using System;
    ...
    public partial class PaymentIFBinding : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback quickVerifyTransactionOperationCompleted;
        ...
        public PaymentIFBinding() {
            this.Url = global::Repository.Properties.Settings.Default.Repository_ir_shaparak_sep1_PaymentIFBinding;
        ...
        /// <remarks/>
        public event quickVerifyTransactionCompletedEventHandler quickVerifyTransactionCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("quickVerifyTransaction", RequestNamespace="urn:Foo", ResponseNamespace="urn:Foo")]
        [return: System.Xml.Serialization.SoapElementAttribute("result")]
        public double quickVerifyTransaction(string String_1, string String_2) {
            object[] results = this.Invoke("quickVerifyTransaction", new object[] {
                        String_1,
                        String_2});
            return ((double)(results[0]));
        }
        ...
        /// <remarks/>
        public void quickVerifyTransactionAsync(string String_1, string String_2) {
            this.quickVerifyTransactionAsync(String_1, String_2, null);
        }
        
        /// <remarks/>
        public void quickVerifyTransactionAsync(string String_1, string String_2, object userState) {
            if ((this.quickVerifyTransactionOperationCompleted == null)) {
                this.quickVerifyTransactionOperationCompleted = new System.Threading.SendOrPostCallback(this.OnquickVerifyTransactionOperationCompleted);
            }
            this.InvokeAsync("quickVerifyTransaction", new object[] {
                        String_1,
                        String_2}, this.quickVerifyTransactionOperationCompleted, userState);
        }
        
        private void OnquickVerifyTransactionOperationCompleted(object arg) {
            if ((this.quickVerifyTransactionCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.quickVerifyTransactionCompleted(this, new quickVerifyTransactionCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    public delegate void quickVerifyTransactionCompletedEventHandler(object sender, quickVerifyTransactionCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class quickVerifyTransactionCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal quickVerifyTransactionCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
