...
namespace Repository.ir.shaparak.bpm {
    using System;
    ...
    public partial class PaymentGatewayImplService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        public PaymentGatewayImplService() {
            this.Url = global::Repository.Properties.Settings.Default.Repository_ir_shaparak_bpm_PaymentGatewayImplService;
        ...
        /// <remarks/>
        public void bpDynamicPayRequestAsync(long terminalId, string userName, string userPassword, long orderId, long amount, string localDate, string localTime, string additionalData, string callBackUrl, string payerId, long subServiceId) {
        ...
        /// <remarks/>
        public void bpDynamicPayRequestAsync(long terminalId, string userName, string userPassword, long orderId, long amount, string localDate, string localTime, string additionalData, string callBackUrl, string payerId, long subServiceId, object userState) {
        ...
        /// <remarks/>
        public void bpPayRequestAsync(long terminalId, string userName, string userPassword, long orderId, long amount, string localDate, string localTime, string additionalData, string callBackUrl, string payerId) {
        ...
        /// <remarks/>
        public void bpPayRequestAsync(long terminalId, string userName, string userPassword, long orderId, long amount, string localDate, string localTime, string additionalData, string callBackUrl, string payerId, object userState) {
