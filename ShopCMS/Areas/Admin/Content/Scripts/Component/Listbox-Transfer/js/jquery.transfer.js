...
var Transfer = (function ($) {
    ...
    function generateTransfer(inputId, currentTimeStr) {
        var htmlStr =
            ...
            + '<div class="tab-item-name tab-item-name-' + currentTimeStr + ' tab-active">گروهها</div>'
            + '<div class="tab-item-name tab-item-name-' + currentTimeStr + '">آیتم ها</div>'
            + '</div>'
            ...
            + '<input class="transfer-double-list-search-input" type="text" id="groupListSearch_' + currentTimeStr + '" placeholder="جستجو" value="" />'
            + '</div>'
            + '</div>'
            ...
            + '<div class="transfer-double-list-header">'
            + '<div class="transfer-double-list-search">'
            + '<input class="transfer-double-list-search-input" type="text" id="listSearch_' + currentTimeStr + '" placeholder="جستجو" value="" />'
            + '</div>'
            + '</div>'
            + '<div class="transfer-double-list-content">'
            + '<div class="transfer-double-list-main">'
            ...
            + '<div class="param-item">انتخاب شده ها</div>'
            + '</div>'
            ...
            + '<input class="transfer-double-selected-list-search-input" type="text" id="selectedListSearch_' + currentTimeStr + '" placeholder="جستجو" value="" />'
            + '</div>'
            + '</div>'
            ...
            + '</div>'
            + '<div class="transfer-double-list-footer">'
            + '<label class="selected_total_num_' + currentTimeStr + '">0 خصوصیت</label>'
            + '</div>'
            + '</div>'
            + '</div>'
            + '</div>'
