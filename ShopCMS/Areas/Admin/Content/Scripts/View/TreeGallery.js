$(document).ready(function () {
    ...
    $("#LanguageFilter").change(function () {
        window.location.href = "/Admin/Gallery?Type=Tree&&LanguageId=" + $(this).val();
    });
    ...
    $("#NewSubMenu").click(function () {
        window.location.href =  "/admin/Gallery/SubCreate/" + CurrentRootId
    });
    $("#EditItem").click(function () {
        window.location.href = "/admin/Gallery/Edit/" + CurrentRootId;
    });
    $("#DeleteItem").click(function () {
        window.location.href =  "/admin/Gallery/Delete/" + CurrentRootId;
    });
    $("#Images").click(function () {
        window.location.href = "/admin/Gallery/ImagesManage/" + CurrentRootId;
    });
